class Navbar extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <div class="nav-prof">
            ...
            <p><a href="https://github.com/rainbowhead" target="_blank" class="intext-link">@rainbowhead</a></p>
            <p>IISER Kolkata</p>
        </div>
        <ul class="nav-list" >
        ...
        <div class="socials">
            <a href="https://github.com/rainbowhead" target="_blank"><i class="fa-brands fa-github"></i></a>
